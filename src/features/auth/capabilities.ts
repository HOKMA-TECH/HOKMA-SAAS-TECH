export const CAPABILITIES = {
  ...
  clients: ['clients.read', 'clients.create', 'clients.update', 'clients.assign', 'clients.export', 'clients.view_sensitive'],
  sensitive: ['leads.view_sensitive'],
...
const roleCapabilities: Record<TenantRole, Capability[]> = {
  corretor: ['leads.read', 'leads.create', 'crm.notes.create', 'crm.notes.read', 'crm.stage.move', 'clients.read', 'clients.create', 'clientes.read', 'clientes.create', 'agenda.read', 'tarefas.read', 'tarefas.create', 'documentos.read'],
  coordenador: ['leads.read', 'leads.create', 'leads.update', 'leads.assign', 'leads.convert', 'leads.view_sensitive', 'crm.notes.create', 'crm.notes.read', 'crm.stage.move', 'clients.read', 'clients.create', 'clients.update', 'clients.assign', 'clients.view_sensitive', 'clientes.read', 'clientes.create', 'clientes.update', 'clientes.assign', 'agenda.read', 'agenda.create', 'agenda.update', 'agenda.manage_team', 'tarefas.read', 'tarefas.create', 'tarefas.assign', 'tarefas.complete', 'documentos.read', 'documentos.upload'],
  gerente: ['leads.read', 'leads.create', 'leads.update', 'leads.assign', 'leads.convert', 'leads.view_sensitive', 'crm.notes.create', 'crm.notes.read', 'crm.stage.move', 'clients.read', 'clients.create', 'clients.update', 'clients.assign', 'clients.export', 'clients.view_sensitive', 'clientes.read', 'clientes.create', 'clientes.update', 'clientes.assign', 'clientes.export', 'agenda.read', 'agenda.create', 'agenda.update', 'agenda.manage_team', 'tarefas.read', 'tarefas.create', 'tarefas.assign', 'tarefas.complete', 'tarefas.report.read', 'tarefas.report.export', 'relatorios.read', 'relatorios.export', 'usuarios.invite', 'documentos.read', 'documentos.upload', 'documentos.generate_signed_url'],
  diretor: ['leads.read', 'leads.create', 'leads.update', 'leads.assign', 'leads.convert', 'leads.view_sensitive', 'crm.notes.create', 'crm.notes.read', 'crm.stage.move', 'clients.read', 'clients.create', 'clients.update', 'clients.assign', 'clients.export', 'clients.view_sensitive', 'clientes.read', 'clientes.create', 'clientes.update', 'clientes.delete', 'clientes.assign', 'clientes.export', 'agenda.read', 'agenda.create', 'agenda.update', 'agenda.manage_team', 'tarefas.read', 'tarefas.create', 'tarefas.assign', 'tarefas.complete', 'tarefas.report.read', 'tarefas.report.export', 'relatorios.read', 'relatorios.export', 'usuarios.invite', 'usuarios.approve', 'usuarios.change_role', 'tenant.settings.manage', 'tenant.audit.read', 'documentos.read', 'documentos.upload', 'documentos.delete', 'documentos.generate_signed_url'],
  administrador: ['leads.read', 'leads.create', 'leads.update', 'leads.assign', 'leads.convert', 'leads.view_sensitive', 'crm.notes.create', 'crm.notes.read', 'crm.stage.move', 'clients.read', 'clients.create', 'clients.update', 'clients.assign', 'clients.export', 'clients.view_sensitive', 'clientes.read', 'clientes.create', 'clientes.update', 'clientes.delete', 'clientes.assign', 'clientes.export', 'agenda.read', 'agenda.create', 'agenda.update', 'agenda.manage_team', 'tarefas.read', 'tarefas.create', 'tarefas.assign', 'tarefas.complete', 'tarefas.report.read', 'tarefas.report.export', 'relatorios.read', 'relatorios.export', 'usuarios.invite', 'usuarios.approve', 'usuarios.suspend', 'usuarios.change_role', 'tenant.settings.manage', 'tenant.audit.read', 'documentos.read', 'documentos.upload', 'documentos.delete', 'documentos.generate_signed_url'],
